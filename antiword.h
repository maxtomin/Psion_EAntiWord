...
#ifdef __SYMBIAN32__
#define DEFAULT_SCREEN_WIDTH	 0x7FFFFFL
#define MAX_SCREEN_WIDTH	0x7FFFFFL
#define EXIT_FAILURE EXIT_SUCCESS 
//if main value != 0 EPOC console is immediately closing, 
//but we need to show an error to user
#else
...
#ifdef __SYMBIAN32__
extern diagram_type *pCreateDiagram(const char *, const char *, FILE *);
#else
